...
import { fetchBookById, placeOrder } from '../services/api';
      ...
      <div className="container">
        ...
        <div className="book-detail__grid">
          ...
          <div className="book-detail__order">
            ...
            <p className="book-detail__order-sub">
              Pay via bKash / Nagad / Rocket, then fill out the form below.
            </p>

            <div className="payment-info">
              <div className="payment-info__label">Send payment to:</div>
              <div className="payment-info__number">01712-000111</div>
              <div className="payment-info__methods">bKash · Nagad · Rocket</div>
            </div>
            ...
            <form onSubmit={handleOrder} className="order-form">
              ...
              <div className="form-group">
                ...
                <input name="phone" value={form.phone} onChange={handleChange}
                  className="form-input" placeholder="01XXXXXXXXX" required />
              </div>
              <div className="form-group">
                <label className="form-label">Delivery Address *</label>
                <textarea name="address" value={form.address} onChange={handleChange}
                  className="form-input" rows={3} placeholder="Full delivery address" required />
              </div>
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input name="quantity" type="number" value={form.quantity} onChange={handleChange}
                    className="form-input" min={1} max={10} />
                </div>
              </div>
              <div className="form-group">
                ...
                <input name="transactionId" value={form.transactionId} onChange={handleChange}
                  className="form-input" placeholder="e.g. ABC1234567" required />
              </div>
              <div className="form-group">
                <label className="form-label">Note (optional)</label>
                <textarea name="note" value={form.note} onChange={handleChange}
                  className="form-input" rows={2} placeholder="Any special instructions..." />
              </div>
